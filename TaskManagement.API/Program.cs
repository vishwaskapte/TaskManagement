...
var logger = new LoggerConfiguration()
    .WriteTo.Console()
    .WriteTo.File("Logs/TaskMgmt.txt", rollingInterval: RollingInterval.Day)
...
options.UseSqlServer(builder.Configuration.GetConnectionString("TaskManagementAuthConnectionString")));
